...
return function()
	describe("Type System: Specified scalar types", function()
        ...
        expect(function()
				...
				end).toThrow("Int cannot represent non 32-bit signed integer value: 1e+100")
				expect(function()
					return serialize(-1e100)
				end).toThrow("Int cannot represent non 32-bit signed integer value: -1e+100")
				expect(function()
        ...
        -- Maximum and minimum safe numbers in JS
				-- ROBLOX FIXME? for numbers this large, Lua converts them to scientific notation
				expect(parseValue(9007199254740991)).to.equal("9.007199254741e+15")
				expect(parseValue(-9007199254740991)).to.equal("-9.007199254741e+15")
				-- ROBLOX deviation: no undefined in Lua
				-- expect(function()
				--     return parseValue(nil)
