-- upstream: https://github.com/graphql/graphql-js/blob/7b3241329e1ff49fb647b043b80568f0cf9e1a7c/src/language/__tests__/blockString-test.js
...
return function()
	...
	describe("dedentBlockStringValue", function()
		...
		it("does not alter trailing spaces", function()
			...
			expect(dedentBlockStringValue(rawValue)).to.equal(joinLines(
				"Hello,     ",
				"  World!   ",
				"           ",
				"Yours,     ",
	...
	describe("printBlockString", function()
		...
		it("correctly prints string with a first line indentation", function()
			...
			expect(printBlockString(str)).to.equal(joinLines(
				"\"\"\"",
				"    first  ",
				"  line     ",
				"indentation",
